...
(declare-datatypes ((pair3 0))
  (((pair22 (proj1-pair2 sk) (proj2-pair2 sk)))))
(declare-datatypes ((list2 0))
  (((nil2) (cons2 (head2 sk) (tail2 list2)))))
(declare-datatypes ((Maybe 0))
  (((Nothing2) (Just2 (proj1-Just2 sk)))))
(declare-datatypes ((pair 0))
  (((pair2 (proj1-pair sk) (proj2-pair Maybe)))))
(declare-datatypes ((Maybe2 0))
  (((Nothing) (Just (proj1-Just pair)))))
(declare-datatypes ((Seq 0))
  (((Nil) (Cons (proj1-Cons pair) (proj2-Cons Seq2)))))
(declare-datatypes ((Seq3 0))
  (((Nil2) (Cons2 (proj1-Cons2 sk) (proj2-Cons2 Seq)))))
