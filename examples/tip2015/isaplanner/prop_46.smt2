...
(declare-datatypes ((pair 0))
  (((pair2 (proj1-pair Any) (proj2-pair sk)))))
(declare-datatypes ((list4 0))
  (((nil4) (cons4 (head4 sk) (tail4 list4)))))
(declare-datatypes ((list3 0))
  (((nil3) (cons3 (head3 pair3) (tail3 list3)))))
(declare-datatypes ((list2 0))
  (((nil2) (cons2 (head2 pair) (tail2 list2)))))
(declare-datatypes ((list 0))
  (((nil) (cons (head Any) (tail list)))))
(define-fun-rec
  zip2
