...
-- goal_25: (cyclegg_eq (cyclegg_max cyclegg_a cyclegg_b) cyclegg_b) = (cyclegg_leq cyclegg_a cyclegg_b)
module Goal25 where
...
{-@ goal_25 :: cyclegg_a: Cyclegg_Nat -> cyclegg_b: Cyclegg_Nat -> { (cyclegg_eq (cyclegg_max cyclegg_a cyclegg_b) cyclegg_b) = (cyclegg_leq cyclegg_a cyclegg_b) } @-}
goal_25 :: Cyclegg_Nat -> Cyclegg_Nat -> Proof
goal_25 cyclegg_a cyclegg_b =
  case cyclegg_a of
    (Cyclegg_S cyclegg_a_50) ->
      case cyclegg_b of
        (Cyclegg_S cyclegg_b_100) ->
          -- case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50) =>
          -- case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100) =>
          -- (cyclegg_max (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          -- case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100) =>
          -- (cyclegg_eq (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          goal_25 (cyclegg_a_50) (cyclegg_b_100)
          -- goal_25-(cyclegg_eq (cyclegg_max ?cyclegg_a ?cyclegg_b) ?cyclegg_b)=(cyclegg_leq ?cyclegg_a ?cyclegg_b) =>
          -- <= (cyclegg_leq (Cyclegg_S ?x) (Cyclegg_S ?y))
          -- <= case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50)
          -- <= case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100)
        (Cyclegg_Z ) ->
          -- case-split:goal_25:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=Cyclegg_Z =>
    ...
    (Cyclegg_Z ) ->
      case cyclegg_b of
        (Cyclegg_S cyclegg_b_80) ->
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z =>
          -- (cyclegg_max Cyclegg_Z ?y) =>
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z:cyclegg_b=(Cyclegg_S cyclegg_b_80) =>
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z:cyclegg_b=(Cyclegg_S cyclegg_b_80) =>
          -- (cyclegg_eq (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          -- <= (cyclegg_max Cyclegg_Z ?y)
          -- <= case-split:goal_25:cyclegg_a=Cyclegg_Z
          goal_25 (cyclegg_a) (cyclegg_b_80)
          -- goal_25-(cyclegg_eq (cyclegg_max ?cyclegg_a ?cyclegg_b) ?cyclegg_b)=(cyclegg_leq ?cyclegg_a ?cyclegg_b) =>
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z =>
        ...
        (Cyclegg_Z ) ->
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z =>
          -- (cyclegg_max Cyclegg_Z ?y) =>
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z:cyclegg_b=Cyclegg_Z =>
          -- case-split:goal_25:cyclegg_a=Cyclegg_Z:cyclegg_b=Cyclegg_Z =>
