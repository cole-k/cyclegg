...
-- goal_56: (cyclegg_append (cyclegg_drop cyclegg_n cyclegg_xs) (cyclegg_drop (cyclegg_sub cyclegg_n (cyclegg_len cyclegg_xs)) cyclegg_ys)) = (cyclegg_drop cyclegg_n (cyclegg_append cyclegg_xs cyclegg_ys))
module Goal56 where
...
{-@ goal_56 :: cyclegg_n: Cyclegg_Nat -> cyclegg_xs: (Cyclegg_List cyclegg_a) -> cyclegg_ys: (Cyclegg_List cyclegg_a) -> { (cyclegg_append (cyclegg_drop cyclegg_n cyclegg_xs) (cyclegg_drop (cyclegg_sub cyclegg_n (cyclegg_len cyclegg_xs)) cyclegg_ys)) = (cyclegg_drop cyclegg_n (cyclegg_append cyclegg_xs cyclegg_ys)) } @-}
goal_56 :: Cyclegg_Nat -> (Cyclegg_List cyclegg_a) -> (Cyclegg_List cyclegg_a) -> Proof
goal_56 cyclegg_n cyclegg_xs cyclegg_ys =
  case cyclegg_n of
    (Cyclegg_S cyclegg_n_100) ->
      case cyclegg_xs of
        (Cyclegg_Cons cyclegg_xs_170 cyclegg_xs_171) ->
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100) =>
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100):cyclegg_xs=(Cyclegg_Cons cyclegg_xs_170 cyclegg_xs_171) =>
          -- (cyclegg_drop (Cyclegg_S ?n) (Cyclegg_Cons ?x ?xs)) =>
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100) =>
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100):cyclegg_xs=(Cyclegg_Cons cyclegg_xs_170 cyclegg_xs_171) =>
          -- (cyclegg_len (Cyclegg_Cons ?x ?xs)) =>
          -- (cyclegg_sub (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          goal_56 (cyclegg_n_100) (cyclegg_xs_171) (cyclegg_ys)
          -- <= goal_56-(cyclegg_drop ?cyclegg_n (cyclegg_append ?cyclegg_xs ?cyclegg_ys))=(cyclegg_append (cyclegg_drop ?cyclegg_n ?cyclegg_xs) (cyclegg_drop (cyclegg_sub ?cyclegg_n (cyclegg_len ?cyclegg_xs)) ?cyclegg_ys))
          -- <= (cyclegg_drop (Cyclegg_S ?n) (Cyclegg_Cons ?x ?xs))
          -- <= case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100)
        ...
        (Cyclegg_Nil ) ->
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100) =>
          -- case-split:goal_56:cyclegg_n=(Cyclegg_S cyclegg_n_100):cyclegg_xs=Cyclegg_Nil =>
          ...
          ()
    (Cyclegg_Z ) ->
      -- case-split:goal_56:cyclegg_n=Cyclegg_Z =>
