...
-- goal_86: (cyclegg_append (cyclegg_zip (cyclegg_take (cyclegg_len cyclegg_ys) cyclegg_xs) cyclegg_ys) (cyclegg_zip (cyclegg_drop (cyclegg_len cyclegg_ys) cyclegg_xs) cyclegg_zs)) = (cyclegg_zip cyclegg_xs (cyclegg_append cyclegg_ys cyclegg_zs))
module Goal86 where
...
{-@ goal_86 :: cyclegg_xs: (Cyclegg_List cyclegg_a) -> cyclegg_ys: (Cyclegg_List cyclegg_a) -> cyclegg_zs: (Cyclegg_List cyclegg_a) -> { (cyclegg_append (cyclegg_zip (cyclegg_take (cyclegg_len cyclegg_ys) cyclegg_xs) cyclegg_ys) (cyclegg_zip (cyclegg_drop (cyclegg_len cyclegg_ys) cyclegg_xs) cyclegg_zs)) = (cyclegg_zip cyclegg_xs (cyclegg_append cyclegg_ys cyclegg_zs)) } @-}
goal_86 :: (Cyclegg_List cyclegg_a) -> (Cyclegg_List cyclegg_a) -> (Cyclegg_List cyclegg_a) -> Proof
goal_86 cyclegg_xs cyclegg_ys cyclegg_zs =
  case cyclegg_xs of
    (Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111) ->
      case cyclegg_ys of
        (Cyclegg_Cons cyclegg_ys_200 cyclegg_ys_201) ->
          -- case-split:goal_86:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111):cyclegg_ys=(Cyclegg_Cons cyclegg_ys_200 cyclegg_ys_201) =>
          -- (cyclegg_len (Cyclegg_Cons ?x ?xs)) =>
          -- case-split:goal_86:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111) =>
          ...
          goal_86 (cyclegg_xs_111) (cyclegg_ys_201) (cyclegg_zs)
          -- goal_86-(cyclegg_append (cyclegg_zip (cyclegg_take (cyclegg_len ?cyclegg_ys) ?cyclegg_xs) ?cyclegg_ys) (cyclegg_zip (cyclegg_drop (cyclegg_len ?cyclegg_ys) ?cyclegg_xs) ?cyclegg_zs))=(cyclegg_zip ?cyclegg_xs (cyclegg_append ?cyclegg_ys ?cyclegg_zs)) =>
          -- <= (cyclegg_zip (Cyclegg_Cons ?x ?xs) (Cyclegg_Cons ?y ?ys))
          -- <= case-split:goal_86:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111)
          -- <= (cyclegg_append (Cyclegg_Cons ?x ?xs) ?ys)
          -- <= case-split:goal_86:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111):cyclegg_ys=(Cyclegg_Cons cyclegg_ys_200 cyclegg_ys_201)
        (Cyclegg_Nil ) ->
          -- case-split:goal_86:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_110 cyclegg_xs_111):cyclegg_ys=Cyclegg_Nil =>
    ...
    (Cyclegg_Nil ) ->
      case cyclegg_ys of
        (Cyclegg_Cons cyclegg_ys_120 cyclegg_ys_121) ->
          -- case-split:goal_86:cyclegg_xs=Cyclegg_Nil:cyclegg_ys=(Cyclegg_Cons cyclegg_ys_120 cyclegg_ys_121) =>
          -- (cyclegg_len (Cyclegg_Cons ?x ?xs)) =>
          -- case-split:goal_86:cyclegg_xs=Cyclegg_Nil =>
          ...
          ()
        (Cyclegg_Nil ) ->
          -- case-split:goal_86:cyclegg_xs=Cyclegg_Nil:cyclegg_ys=Cyclegg_Nil =>
          -- (cyclegg_zip ?xs Cyclegg_Nil) =>
          -- (cyclegg_append Cyclegg_Nil ?ys) =>
          -- case-split:goal_86:cyclegg_xs=Cyclegg_Nil:cyclegg_ys=Cyclegg_Nil =>
          -- (cyclegg_len Cyclegg_Nil) =>
