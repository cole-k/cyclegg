...
-- goal_33: (cyclegg_eq (cyclegg_min cyclegg_a cyclegg_b) cyclegg_a) = (cyclegg_leq cyclegg_a cyclegg_b)
module Goal33 where
...
{-@ goal_33 :: cyclegg_a: Cyclegg_Nat -> cyclegg_b: Cyclegg_Nat -> { (cyclegg_eq (cyclegg_min cyclegg_a cyclegg_b) cyclegg_a) = (cyclegg_leq cyclegg_a cyclegg_b) } @-}
goal_33 :: Cyclegg_Nat -> Cyclegg_Nat -> Proof
goal_33 cyclegg_a cyclegg_b =
  case cyclegg_a of
    (Cyclegg_S cyclegg_a_50) ->
      case cyclegg_b of
        (Cyclegg_S cyclegg_b_100) ->
          -- case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50) =>
          -- case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100) =>
          -- (cyclegg_min (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          -- case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50) =>
          -- (cyclegg_eq (Cyclegg_S ?x) (Cyclegg_S ?y)) =>
          goal_33 (cyclegg_a_50) (cyclegg_b_100)
          -- goal_33-(cyclegg_eq (cyclegg_min ?cyclegg_a ?cyclegg_b) ?cyclegg_a)=(cyclegg_leq ?cyclegg_a ?cyclegg_b) =>
          -- <= (cyclegg_leq (Cyclegg_S ?x) (Cyclegg_S ?y))
          -- <= case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50)
          -- <= case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=(Cyclegg_S cyclegg_b_100)
        (Cyclegg_Z ) ->
          -- case-split:goal_33:cyclegg_a=(Cyclegg_S cyclegg_a_50):cyclegg_b=Cyclegg_Z =>
          ...
          ()
    (Cyclegg_Z ) ->
      -- case-split:goal_33:cyclegg_a=Cyclegg_Z =>
