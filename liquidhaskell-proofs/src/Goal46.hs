...
-- goal_46: (cyclegg_zip Cyclegg_Nil cyclegg_xs) = Cyclegg_Nil
module Goal46 where
...
{-@ goal_46 :: cyclegg_xs: (Cyclegg_List cyclegg_a) -> { (cyclegg_zip Cyclegg_Nil cyclegg_xs) = Cyclegg_Nil } @-}
goal_46 :: (Cyclegg_List cyclegg_a) -> Proof
goal_46 cyclegg_xs =
