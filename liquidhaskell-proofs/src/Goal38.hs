...
-- goal_38: (Cyclegg_S (cyclegg_count cyclegg_n cyclegg_xs)) = (cyclegg_count cyclegg_n (cyclegg_append cyclegg_xs (Cyclegg_Cons cyclegg_n Cyclegg_Nil)))
module Goal38 where
...
{-@ goal_38 :: cyclegg_n: Cyclegg_Nat -> cyclegg_xs: (Cyclegg_List Cyclegg_Nat) -> { (Cyclegg_S (cyclegg_count cyclegg_n cyclegg_xs)) = (cyclegg_count cyclegg_n (cyclegg_append cyclegg_xs (Cyclegg_Cons cyclegg_n Cyclegg_Nil))) } @-}
goal_38 :: Cyclegg_Nat -> (Cyclegg_List Cyclegg_Nat) -> Proof
goal_38 cyclegg_n cyclegg_xs =
  case cyclegg_xs of
    (Cyclegg_Cons cyclegg_xs_80 cyclegg_xs_81) ->
      let g_17 = (cyclegg_eq cyclegg_n cyclegg_xs_80) in
        case g_17 of
          (Cyclegg_False ) ->
            -- case-split:goal_38:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_80 cyclegg_xs_81) =>
            -- (cyclegg_count ?x (Cyclegg_Cons ?y ?ys)) =>
            -- adding scrutinee g_17 to split condition (cyclegg_eq cyclegg_n cyclegg_xs_80) =>
            -- case-split:goal_38:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_80 cyclegg_xs_81):g_17=Cyclegg_False =>
            -- (cyclegg_ite Cyclegg_False ?x ?y) =>
            -- <= (cyclegg_ite Cyclegg_False ?x ?y)
            -- <= case-split:goal_38:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_80 cyclegg_xs_81):g_17=Cyclegg_False
            -- <= adding scrutinee g_17 to split condition (cyclegg_eq cyclegg_n cyclegg_xs_80)
            goal_38 (cyclegg_n) (cyclegg_xs_81)
            -- <= goal_38-(cyclegg_count ?cyclegg_n (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_n Cyclegg_Nil)))=(Cyclegg_S (cyclegg_count ?cyclegg_n ?cyclegg_xs))
            ? goal_38 (cyclegg_n) (cyclegg_xs_81)
            -- <= goal_38-(cyclegg_count ?cyclegg_n (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_n Cyclegg_Nil)))=(Cyclegg_S (cyclegg_count ?cyclegg_n ?cyclegg_xs))
            -- <= (cyclegg_count ?x (Cyclegg_Cons ?y ?ys))
          ...
          (Cyclegg_True ) ->
            ...
            -- (cyclegg_count ?x (Cyclegg_Cons ?y ?ys)) =>
            -- adding scrutinee g_17 to split condition (cyclegg_eq cyclegg_n cyclegg_xs_80) =>
            -- case-split:goal_38:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_80 cyclegg_xs_81):g_17=Cyclegg_True =>
    ...
    (Cyclegg_Nil ) ->
      let g_11 = (cyclegg_eq cyclegg_n cyclegg_n) in
        case g_11 of
          (Cyclegg_False ) ->
            case cyclegg_n of
              (Cyclegg_S cyclegg_n_150) ->
                -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil =>
                -- (cyclegg_count ?x Cyclegg_Nil) =>
                -- <= (cyclegg_count ?x Cyclegg_Nil)
                -- <= case-split:goal_38:cyclegg_xs=Cyclegg_Nil
                goal_38 (cyclegg_n_150) (cyclegg_xs)
                -- <= goal_38-(cyclegg_count ?cyclegg_n (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_n Cyclegg_Nil)))=(Cyclegg_S (cyclegg_count ?cyclegg_n ?cyclegg_xs))
                -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil =>
                ...
                -- <= case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_False:cyclegg_n=(Cyclegg_S cyclegg_n_150)
                -- <= case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_False:cyclegg_n=(Cyclegg_S cyclegg_n_150)
                -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil =>
                -- (cyclegg_count ?x Cyclegg_Nil) =>
                -- <= (cyclegg_count ?x Cyclegg_Nil)
              ...
              (Cyclegg_Z ) ->
                unreachable (
                  -- <= case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_False
                  -- <= adding scrutinee g_11 to split condition (cyclegg_eq cyclegg_n cyclegg_n)
                  -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_False:cyclegg_n=Cyclegg_Z =>
                  -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_False:cyclegg_n=Cyclegg_Z =>
          ...
          (Cyclegg_True ) ->
            -- <= (cyclegg_ite Cyclegg_True ?x ?y)
            -- <= case-split:goal_38:cyclegg_xs=Cyclegg_Nil:g_11=Cyclegg_True
            -- <= adding scrutinee g_11 to split condition (cyclegg_eq cyclegg_n cyclegg_n)
            -- <= (cyclegg_count ?x (Cyclegg_Cons ?y ?ys))
            -- case-split:goal_38:cyclegg_xs=Cyclegg_Nil =>
            -- <= (cyclegg_append Cyclegg_Nil ?ys)
