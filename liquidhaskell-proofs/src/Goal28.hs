...
-- goal_28: (cyclegg_elem cyclegg_x (cyclegg_append cyclegg_xs (Cyclegg_Cons cyclegg_x Cyclegg_Nil))) = Cyclegg_True
module Goal28 where
...
{-@ goal_28 :: cyclegg_x: Cyclegg_Nat -> cyclegg_xs: (Cyclegg_List Cyclegg_Nat) -> { (cyclegg_elem cyclegg_x (cyclegg_append cyclegg_xs (Cyclegg_Cons cyclegg_x Cyclegg_Nil))) = Cyclegg_True } @-}
goal_28 :: Cyclegg_Nat -> (Cyclegg_List Cyclegg_Nat) -> Proof
goal_28 cyclegg_x cyclegg_xs =
  case cyclegg_xs of
    (Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71) ->
      let g_14 = (cyclegg_eq cyclegg_x cyclegg_xs_70) in
        case g_14 of
          (Cyclegg_False ) ->
            -- case-split:goal_28:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71) =>
            -- (cyclegg_append (Cyclegg_Cons ?x ?xs) ?ys) =>
            -- (cyclegg_elem ?n (Cyclegg_Cons ?x ?xs)) =>
            goal_28 (cyclegg_x) (cyclegg_xs_71)
            -- <= goal_28-(cyclegg_elem ?cyclegg_x (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_x Cyclegg_Nil)))=Cyclegg_True
            -- adding scrutinee g_14 to split condition (cyclegg_eq cyclegg_x cyclegg_xs_70) =>
            -- case-split:goal_28:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):g_14=Cyclegg_False =>
          ...
          (Cyclegg_True ) ->
            ...
            -- <= goal_28-(cyclegg_elem ?cyclegg_x (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_x Cyclegg_Nil)))=Cyclegg_True
            -- adding scrutinee g_14 to split condition (cyclegg_eq cyclegg_x cyclegg_xs_70) =>
            -- case-split:goal_28:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):g_14=Cyclegg_True =>
            -- (cyclegg_ite Cyclegg_True ?x ?y) =>
            ? goal_28 (cyclegg_x) (cyclegg_xs_71)
            -- goal_28-(cyclegg_elem ?cyclegg_x (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_x Cyclegg_Nil)))=Cyclegg_True =>
    (Cyclegg_Nil ) ->
      let g_8 = (cyclegg_eq cyclegg_x cyclegg_x) in
        case g_8 of
          (Cyclegg_False ) ->
            case cyclegg_x of
              (Cyclegg_S cyclegg_x_150) ->
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil =>
                ...
                -- <= (cyclegg_elem ?n Cyclegg_Nil)
                -- <= case-split:goal_28:cyclegg_xs=Cyclegg_Nil
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False:cyclegg_x=(Cyclegg_S cyclegg_x_150) =>
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False:cyclegg_x=(Cyclegg_S cyclegg_x_150) =>
                ...
                -- <= (cyclegg_append Cyclegg_Nil ?ys)
                -- <= case-split:goal_28:cyclegg_xs=Cyclegg_Nil
                goal_28 (cyclegg_x_150) (cyclegg_xs)
                -- goal_28-(cyclegg_elem ?cyclegg_x (cyclegg_append ?cyclegg_xs (Cyclegg_Cons ?cyclegg_x Cyclegg_Nil)))=Cyclegg_True =>
              (Cyclegg_Z ) ->
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil =>
                -- (cyclegg_append Cyclegg_Nil ?ys) =>
                -- <= case-split:goal_28:cyclegg_xs=Cyclegg_Nil
                -- (cyclegg_elem ?n (Cyclegg_Cons ?x ?xs)) =>
                -- adding scrutinee g_8 to split condition (cyclegg_eq cyclegg_x cyclegg_x) =>
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False =>
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil =>
                -- (cyclegg_elem ?n Cyclegg_Nil) =>
                -- <= case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False
                -- <= adding scrutinee g_8 to split condition (cyclegg_eq cyclegg_x cyclegg_x)
                -- (cyclegg_ite Cyclegg_False ?x ?y) =>
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False:cyclegg_x=Cyclegg_Z =>
                -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_False:cyclegg_x=Cyclegg_Z =>
          ...
          (Cyclegg_True ) ->
            ...
            -- (cyclegg_elem ?n (Cyclegg_Cons ?x ?xs)) =>
            -- adding scrutinee g_8 to split condition (cyclegg_eq cyclegg_x cyclegg_x) =>
            -- case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_True =>
            -- <= case-split:goal_28:cyclegg_xs=Cyclegg_Nil:g_8=Cyclegg_True
            -- <= adding scrutinee g_8 to split condition (cyclegg_eq cyclegg_x cyclegg_x)
            -- (cyclegg_ite Cyclegg_True ?x ?y) =>
            -- adding scrutinee g_8 to split condition (cyclegg_eq cyclegg_x cyclegg_x) =>
