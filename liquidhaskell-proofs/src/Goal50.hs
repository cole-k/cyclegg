...
-- goal_50: (cyclegg_butlast cyclegg_xs) = (cyclegg_take (cyclegg_sub (cyclegg_len cyclegg_xs) (Cyclegg_S Cyclegg_Z)) cyclegg_xs)
module Goal50 where
...
{-@ goal_50 :: cyclegg_xs: (Cyclegg_List cyclegg_a) -> { (cyclegg_butlast cyclegg_xs) = (cyclegg_take (cyclegg_sub (cyclegg_len cyclegg_xs) (Cyclegg_S Cyclegg_Z)) cyclegg_xs) } @-}
goal_50 :: (Cyclegg_List cyclegg_a) -> Proof
goal_50 cyclegg_xs =
  case cyclegg_xs of
    (Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71) ->
      case cyclegg_xs_71 of
        (Cyclegg_Cons cyclegg_xs_71_170 cyclegg_xs_71_171) ->
          -- case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71) =>
          -- case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):cyclegg_xs_71=(Cyclegg_Cons cyclegg_xs_71_170 cyclegg_xs_71_171) =>
          -- (cyclegg_butlast (Cyclegg_Cons ?x (Cyclegg_Cons ?y ?ys))) =>
          -- <= case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):cyclegg_xs_71=(Cyclegg_Cons cyclegg_xs_71_170 cyclegg_xs_71_171)
          goal_50 (cyclegg_xs_71)
          -- goal_50-(cyclegg_butlast ?cyclegg_xs)=(cyclegg_take (cyclegg_sub (cyclegg_len ?cyclegg_xs) (Cyclegg_S Cyclegg_Z)) ?cyclegg_xs) =>
          -- case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):cyclegg_xs_71=(Cyclegg_Cons cyclegg_xs_71_170 cyclegg_xs_71_171) =>
        ...
        (Cyclegg_Nil ) ->
          -- case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71) =>
          -- case-split:goal_50:cyclegg_xs=(Cyclegg_Cons cyclegg_xs_70 cyclegg_xs_71):cyclegg_xs_71=Cyclegg_Nil =>
          ...
          ()
    (Cyclegg_Nil ) ->
      -- case-split:goal_50:cyclegg_xs=Cyclegg_Nil =>
